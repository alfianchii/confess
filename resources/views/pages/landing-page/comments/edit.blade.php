                ...
                <div class="row justify-content-center">
                    <div class="col-12 mb-3 header-about mt-3">
                        ...
                        <p class="text-subtitle text-muted">
                            Lakukan penyuntingan komentar yang telah kamu buat.
                        </p>
                        <hr>
                        <div class="mb-3">
            ...
            <section class="section">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="/comments/{{ base64_encode($comment->id_confession_comment) }}"
                                    ...
                                    <div class="col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <select class="form-select" id="privacy" name="privacy">
                                                ...
                                                <option @if (old('privacy', $comment->privacy) === 'anonymous') selected @endif value="anonymous"
                                ...
                                @if ($comment->attachment_file)
                                    <div class="mb-4">
                                        <div class="attachment-file">
                                            <a class="btn btn-danger px-2 pt-2 position-absolute" data-bs-toggle="tooltip"
