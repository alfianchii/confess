        ...
        <div class="page-content mt-4">
            <section class="row">
                <div class="col-12 col-lg-9">
                                    ...
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                                                ...
                                                <div class="stats-icon mb-2" style="background-color: #ffbe55;">
                                ...
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                                                class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                                                <div class="stats-icon mb-2" style="background-color: #6574ff;">
                    ...
                    <div class="row user-select-none">
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard#'" data-bs-toggle="tooltip"
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard#'"
                                data-bs-toggle="tooltip"
                                data-bs-original-title="Jumlah seluruh tanggapan yang telah dibuat oleh 'officer' ataupun 'student' terhadap suatu pengakuan (system's responses included).">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard/comments'"
                                data-bs-toggle="tooltip"
                                data-bs-original-title="Jumlah seluruh komentar yang telah dibuat oleh semua pengguna terhadap suatu pengakuan.">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard#stat-log-in'"
                                data-bs-toggle="tooltip"
                                data-bs-original-title="Jumlah riwayat logging-in yang dilakukan semua pengguna.">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                    ...
                    <div class="row" id="stat-log-in">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3>Statistik Log-in Kamu</h3>
                                </div>
                                <div class="card-body">
                                    <div id="chart-your-log-in">
                                        <div class="d-flex justify-content-center skeleton-loading">
                                            <div class="spinner-border" style="width: 3rem; height: 3rem" role="status">
                                                <span class="visually-hidden">Loading...</span>
                                            </div>
