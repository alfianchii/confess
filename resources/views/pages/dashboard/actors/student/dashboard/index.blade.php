            ...
            <section class="row">
                    ...
                    <div class="row user-select-none">
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard/confessions/responses'"
                                ...
                                data-bs-original-title="Jumlah tanggapan yang telah dibuat oleh para 'officers' kepada 'confessions' kamu (system's responses included).">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                ...
                                                <h6 class="font-extrabold mb-0">
                                                    {{ $responsesFromYourConfessionCount }}
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a style="cursor: pointer" onclick="window.location.href='/dashboard/confessions/comments'"
                                data-bs-toggle="tooltip"
                                data-bs-original-title="Jumlah komentar yang telah dibuat oleh kamu terhadap semua 'confessions'.">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a tabindex="1" id="log-in-tag" style="cursor: pointer" data-bs-toggle="tooltip"
                                data-bs-original-title="Jumlah riwayat logging-in yang kamu lakukan.">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            <div
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3>Statistik Pengakuan, Tanggapan, Komentar, dan Log-in Kamu</h3>
                                </div>
                                <div class="card-body">
                                    <div id="chart-your-confession-response-comment-log-in">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @forelse ($recentResponsesFromYourConfession as $response)
                                <a class="text-muted"
